"""Regression checks for the granite-lang-diagnostic-loom casebook."""
...
from casebook.harness import assert_expected, granite_lang_diagnostic_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(granite_lang_diagnostic_loom_summary(), assert_expected())
