...
$repo = "granite-lang-diagnostic-loom"
$language = "Julia"
$category = "Compilers"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/granite-lang-diagnostic-walkthrough.md")) {
